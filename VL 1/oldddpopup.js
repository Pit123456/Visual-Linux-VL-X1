			...
			var CD = '<div id="cd">'+
						...
						'<div id="fRow">'+
							...
							'<div id="removeRow">'+
								...
								'<div class="clear"></div>'+
								'<input class="create2" id="Input1" type=text name=Fname placeholder="Destination Path">'+
							'</div>'+
			...
			var CP = '<div id="cp">'+
						...
						'<div id="fCPRow">'+
							...
							'<div id="STRow">'+
								...
								'<input class="browse" id="Input2" type=text name=Fname placeholder="Path">'+
							'</div>'+
			...
			var Rename = '<div id="cp">'+
				...
				'<div id="fCPRow">'+
					...
					'<div id="STRow">'+
						...
						'<input class="browse" id="InputName" type=text name=newName placeholder="New Name">'+
...
//--------------Minimize + Resize-----------------------------//
		...
		function minimize() {
			...
			if(sizeWindow==1){
				...
				document.getElementById("textCommandLine").style.height="385px" ;

				document.getElementById("tclS").style.height="295px" ;

				document.getElementById("visualCommandLine").style.height="385px" ;

				document.getElementById("vclS").style.height="295px" ;
		...
		function resize() {
				...
				document.getElementById("textCommandLine").style.height="230px" ;

				document.getElementById("tclS").style.height="140px" ;

				document.getElementById("visualCommandLine").style.height="230px" ;

				document.getElementById("vclS").style.height="140px" ;
...
//---------------Enter New Command----------------------------//
    	...
    	function newTextCommand(str, macro){
    		...
    		if(TcommandCounter>1){
    			green = '<img class="greenS3" id="gBtn'+TcommandCounter+'" src="images/greenStart2.png">';
    			document.getElementById("g1Btn").className="greenS3";
    		};
    	...
    	function newVisualCommand(str, macro){
			...
			if(VcommandCounter==1){  // Enter First Command
				...
				if(macro){ // Case of Macro Command
					...
					'<section class="'+nestClass+'">'+
						...
						'<a href="JavaScript:openScript(1);"><img id="scriptPlus" src="images/plus.png"></a>'+
						'<br>'+
						'<img id="pipeMacro" src="images/linkCommandMacro.png">'+
					'</section>'+
					'<section id="script1"></section>'+
					'<section id="firstCommandScript">'+
					'</section>'

					document.getElementById("script").innerHTML=script;
					document.getElementById("firstCommandScript").innerHTML=command;
					openScript(0);
					runOnce=0;			
				}
			}
			...
			if(VcommandCounter>1){  // Enter Others Commands
				...
				if(!macro){ // first command after macro
					var final;
					if((macroCount>0)&&(lastMacro==true)){
						document.getElementById("script1").innerHTML=command ;
						lastMacro = false;
						final = true;
					}
					else {
    	...
    	function openScript(i){
    		...
    		if(open==1){ // Case of Open Macro
    			open--;
    			document.getElementById("firstCommandScript").style.display="block";
    			temp = document.getElementById("pipeMacro");
    			if(temp){
					document.getElementById("pipeMacro").style.display="block";
    			}
    			var tmp = document.getElementById("script1");
    		...
    		if(open==0){ // Case of Close Macro
    			document.getElementById("firstCommandScript").style.display="none";
    			temp = document.getElementById("pipeMacro");
    			if(temp){
...
//-----------------Create Command-----------------------------//
    	...
    	function inputCreate(){
    		...
    		var finalCommand = currentCommand+" "+InputP.value+" "+Input.value;
