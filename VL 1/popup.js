			...
			for (i = 0; i < check.length; i++) {
				...
				if(check[i].checked){
					...
					if(i==0){
						...
						var tmpCheck = document.getElementsByClassName("Tcheckbox");
						console.log("valueeee  :"+tmpCheck[0]);
						if(tmpCheck[0]==undefined){
							console.log("problemsss");
							//TcommandCounter=0;
							Treset();
							return;
						}
...
//--------------Minimize + Resize-----------------------------//
		...
		function resize() {
				...
				if(TcommandCounter>1){
					...
					document.getElementById("g1Btn").className="greenS2";
					//document.getElementsByClassName("greenS2").className="greenS3";
				}
		}
...
//-------------Read from Text File----------------------------//
	  ...
	  var openFile = function(event) {
	  	console.log("trying to loading text file");
			...
			if(VcommandCounter>1){  // Enter Others Commands
				...
				if(macro){ 
					...
					if(runOnceVisualFunc){
						...
						var script =''+pipe+''+
						'<section id="scriptFolder" class="vclN4">'+
